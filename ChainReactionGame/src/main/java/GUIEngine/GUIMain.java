...
public class GUIMain extends Application {
    ...
    static Stage winnerDialog = new Stage();
    ...
    private static ArrayList<ColorPicker> array_CP = new ArrayList<ColorPicker>(8);
    ...
    public static BorderPane setEmptyGrid(GridPane root, int numRows, int numColumns, Color color){
        ...
        Image redo_img = img_util.getImage("src/main/resources/undo.png");
...
//        }
        ...
        Image bg_image = img_util.getImage("src/main/resources/gamepage.png");
    ...
    public static void playExplode(){
        String musicFile = "src/main/resources/explode.mp3";     // For example
    ...
    public static void playError(){
        String musicFile = "src/main/resources/error.mp3";     // For example
...
//        System.out.println(removal);
    ...
    public static Scene createStartPage() {
        ...
        ImageUtil img_util = new ImageUtil();
        Image bg_image = img_util.getImage("src/main/resources/startpage1.jpg");
...
//        String back_image = img_util.getCSSImage("src/main/resources/startpage.jpg");
...
//        //Image back_image = img_util.getImage("src/main/resources/startpage.jpg");
//
...
//        scene.setFill(pattern);
    ...
    public static Scene createSettingsPage() {
        ...
        ImageUtil img_util = new ImageUtil();
        Image back_img = img_util.getImage("src/main/resources/back.png");
       ...
       // comboBox_8.setStyle("-fx-font-size: 20px; -fx-background-color: black; -fx-border-color: white;");
        ...
        //ImageUtil img_util = new ImageUtil();
        Image bg_image = img_util.getImage("src/main/resources/settingspage.jpg");
        ...
        ArrayList<ColorPicker> cp_array = new ArrayList<ColorPicker>();
    ...
    public static void createEndPage(GridPane grid,Stage stage, int winner){
        ...
        String musicFile = "src/main/resources/win.mp3";     // For example


        Button restartButton = new Button("Play Again");
        endPageRestartGUI.setInputs(grid, stage);
        restartButton.setOnAction(new endPageRestartGUI());

        Button exitButton = new Button("Back to Home Page");
        endPageExitGUI.getInputs(stage);
        exitButton.setOnAction(new endPageExitGUI());
